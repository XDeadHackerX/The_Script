				...
				read -p " Elige una opcion: " opc4
					case $opc4 in
							...
							2 )	echo
								...
								;;
							3 )	echo
								sudo nmap -sV -O -Pn -sS -D 192.168.1.5,192.168.1.225,192.168.1.110 --spoof-mac 0 $opc3
								echo
								;;
							4 )	echo
								sudo nmap -sV -O -Pn -oN $opc3.txt -sS -D 192.168.1.5,192.168.1.225,192.168.1.110 --spoof-mac 0 $opc3
								echo
								echo
								echo "///////////////////////////////////////////////////////"
								echo "El .txt se a guardado en /The_Script/$opc3.txt"
				...
				read -p " Elige una opcion: " opc6
					case $opc6 in
							...
							2 )	echo
								...
								;;
							3 )	echo
								sudo nmap -sV -O -p "*" -Pn -sS -D 192.168.1.5,192.168.1.225,192.168.1.110 --spoof-mac 0 $opc5
								echo
								;;
							4 )	echo
								sudo nmap -sV -O -p "*" -Pn -oN $opc5.txt -sS -D 192.168.1.5,192.168.1.225,192.168.1.110 --spoof-mac 0 $opc5
								echo
								echo
								echo "///////////////////////////////////////////////////////"
								echo "El .txt se a guardado en /The_Script/$opc5.txt"
				...
				read -p " Elige una opcion: " opc8
					case $opc8 in
							...
							2 )	echo
								...
								;;
							3 )	echo
								sudo nmap -v -sV -O -p "*" -Pn -sS -D 192.168.1.5,192.168.1.225,192.168.1.110 --spoof-mac 0 $opc7
								echo
								;;
							4 )	echo
								sudo nmap -v -sV -O -p "*" -Pn -oN $opc7.txt -sS -D 192.168.1.5,192.168.1.225,192.168.1.110 --spoof-mac 0 $opc7
								echo
								echo
								echo "///////////////////////////////////////////////////////"
								echo "El .txt se a guardado en /The_Script/$opc7.txt"
