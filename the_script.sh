...
echo "	4º Informacion de un numero de Telefono  		(Funciona mal)		      "
echo "	5º Encontrar Redes Sociales    			        (No es certero al 100%)	      "
...
read -p " [*] Elige una opcion: " opc
	case $opc in
			...
			2 )	bash requisitos/2.sh
				;;
			3 )	bash requisitos/6.sh
				;;
			4 )	bash requisitos/3.sh
				;;
			5 )	bash requisitos/4.sh
				;;
